...
\thanks{Manuscript received Sept. 1, 2016. This publication is supported in part by the Gordon and Betty Moore Foundation'۪s Data-Driven Discovery Initiative through Grant GBMF4561 to Matthew
...
%\markboth{Journal of Computing in Science and Engineering,~Vol.~X, No.~X, Month~Year}%
%{Bitmap Indexing for Fast Analysis of Large Astrophysical Datasets}
...
% Removed for CiSE 150 word limit
% Mapping data files in this manner will dramatically decrease the time and memory required for loading data during analysis without needing to re-order the data on disk.
\end{abstract}

%\begin{IEEEkeywords}
%Astrophysics, Data analysis, Indexes, Memory management, Scientific computing
%\end{IEEEkeywords}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang1.png}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang2a.png}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang2b.png}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang2c.png}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang3.png}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang4.png}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang5.png}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang6.png}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang7.png}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang8.png}
...
\ifinclfig
	\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang9.png}
...
\ifinclfig
	\begin{figure}[hbpt]
	\begin{center}
	\includegraphics[width=\columnwidth,keepaspectratio]{../images/lang10.png}
...
N-body simulations; currently undergoing review for inclusion in a future version of {\tt yt} (3.4 or later), our implementation is available at {https://bitbucket.org/langmm/yt-bitmap}. The open source EWAHBoolArray C++ package is used for implementing EWAH bitmaps \citep{Lemire2010,Kaser2016} and exposed to Python using Cython \citep{Behnel2011}. 

%---------------------------------------------------------------------------------
% ACKNOWLEDGMENTS
\section*{Acknowledgment}
%\acknowledgments
The authors would like to thank Daniel
